...
.loc_C4001A:        ; Wait for auto-joypad to complete
    ...
    BNE .loc_C4001A
    LDA a:JOY1H
    STA a:addr(joypad_1+1)
    LDA a:JOY1L
    STA a:addr(joypad_1)
    AND #0xF
    STA a:addr(joypad_1_connected)
    LDA a:JOYSER0
    LSR A
    ROL a:addr(joypad_1_connected)
    LDA a:JOY2H
    STA a:addr(joypad_2+1)
    LDA a:JOY2L
    STA a:addr(joypad_2)
    AND #0xF
    STA a:addr(joypad_2_connected)
    LDA a:JOY4H
    STA a:addr(joypad_3+1)
    LDA a:JOY4L
    STA a:addr(joypad_3)
    AND #0xF
    STA a:addr(joypad_3_connected)
    LDA a:JOYSER1
    LSR A
    ROL a:addr(joypad_2_connected)
    LSR A
    ROL a:addr(joypad_3_connected)
    STZ a:WRIO
    LDY #0x10
...
.loc_C4006B:
    ...
    LDA a:addr(joypad_4)
    AND #0xF
    STA a:addr(joypad_4_connected)
    LDA a:addr(joypad_5)
    AND #0xF
    STA a:addr(joypad_5_connected)
    LDA a:JOYSER1
    LSR A
    ROL a:addr(joypad_4_connected)
    LSR A
    ROL a:addr(joypad_5_connected)
    LDA #0x80
    STA a:WRIO
    PLP
    RTS
...
.loc_C4020D:
    ...
    BNE .loc_C4020D
    LDA f:byte3_7E280C
    STA a:addr(word_7E0C8B)
    LDA f:byte3_7E280C+2
    STA a:addr(word_7E0C8D)
    LDA a:addr(word_7E0C8B)
    CMP #0x6D61
    BNE .loc_C40280
    LDA a:addr(word_7E0C8D)
...
; Moved up
    REP #0x20
    LDA #addr(nullsub_1)
    STA $az2:addr(unknown_function_pointer)
    SEP #0x20
    LDA #bank(nullsub_1)
    STA $az2:addr(unknown_function_pointer+2)
endif
    SEP #0x20
    CLI
ifdef J
...
ifdef DEBUG
    ...
    REP #0x20
    LDA #addr(player_2.rendering_linked_list)
    STA a:addr(first_sprite_ptr)
    LDA #addr(player_1.rendering_linked_list)
    STA a:addr(level_manager_object.rendering_linked_list)
    LDA #0xFFFF
    STA a:addr(player_1.rendering_linked_list)
    REP #0x20
    LDA #addr(oam)
    STA a:addr(ptr_7E0306)
    SEP #0x20
    LDA #bank(oam)
    STA a:addr(ptr_7E0306 + 2)
    REP #0x20
    LDX #addr(level_manager_object)
    LDA a:addr(level_manager_object+object.handler+1)
    STA $az:0x51
...
.loc_C403E4:
    ...
    BNE .loc_C403E4
    REP #0x20
    LDY a:addr(level_manager_object.rendering_linked_list)
...
update_bg_scrolling:
    ...
    STA a:BG1HOFS
    LDA a:addr(bg1_h_scroll+1)
    STA a:BG1HOFS
    LDA a:addr(bg1_v_scroll)
    STA a:BG1VOFS
    LDA a:addr(bg1_v_scroll+1)
    STA a:BG1VOFS
    LDA a:addr(bg2_h_scroll)
    STA a:BG2HOFS
    LDA a:addr(bg2_h_scroll+1)
    STA a:BG2HOFS
    LDA a:addr(bg2_v_scroll)
    STA a:BG2VOFS
    LDA a:addr(bg2_v_scroll+1)
    STA a:BG2VOFS
    RTL
...
transfer_bg1_bg3_tilemaps:
    ...
    LDA #bg1_tilemap.end - bg1_tilemap
    STA a:DASL5
    ...
    LDA #bg3_tilemap.end - bg3_tilemap
    STA a:DASL6
    
    LDA #addr(bg3_tilemap)
    STA a:A1TL6
...
vblank:
    ...
    PLB
    CMP f:RDNMI
    LDA f:addr(screen_flags)
    BIT #1
    BNE .loc_C404FE
    ORA #1
    STA f:addr(screen_flags)
...
.loc_C404FE:
    ...
    LDA #0
    STA a:CGADSUB
    LDA a:addr(bg3_v_scroll_2)
    STA a:BG3VOFS
    LDA a:addr(bg3_v_scroll_2+1)
    STA a:BG3VOFS

.loc_C40525:
    REP #0x30
    INC a:addr(frame_count)
    PLY
    PLX
    PLA
    PLB
...
irq:
    ...
    LDA a:TIMEUP
    BPL .loc_C40572
    LDA a:addr(bg3_v_scroll)
    STA a:BG3VOFS
    LDA a:addr(bg3_v_scroll+1)
    STA a:BG3VOFS
    LDA a:addr(main_screen_status)
    STA a:TM
    LDA a:addr(subscreen_status)
    STA a:TS
...
hud_related:
    ...
    JSL copy_to_bg3_tilemap
    REP #0x20
    STZ $az:add_to_score.SCORE
    STZ $az:add_to_score.SCORE + 2
    JSL add_to_score
    RTL
...
.loc_C406E5:
    ...
    BIT #GAME_FLAGS_BATTLE_DELAY | GAME_FLAGS_LEVEL_END
    BEQ .loc_C406F3
    JML .locret_C40768
...
.loc_C406F3:
    INC $az:0x12, X
    LDA $az:0x12, X
    CMP a:addr(level_manager_object.anonymous_10)
    BNE .locret_C40768
    STZ $az:0x12, X
    SEP #0x20
    LDY #0x5E
...
.loc_C4073B:
    ...
    INC a:addr(story_mode_timers)
    INC a:addr(story_mode_timers)

.loc_C40746:
    LDA a:addr(player_2.unknown_flags)
    BEQ .locret_C40768
    LDA a:addr(story_mode_timers + 2)
    CMP #0x1C
    BNE .loc_C40756
    JML hurry_up
...
.loc_C40756:
    ...
    LDA #0xA7
    STA a:addr(bg3_tilemap+0x40), Y
    INC a:addr(story_mode_timers + 2)
    INC a:addr(story_mode_timers + 2)
...
.loc_C407FC:
    ...
    SEC
    SBC #1
    STA a:addr(level_manager_object.anonymous_10)
    CLD
    SEP #0x20
    CMP #0x60
    BCC sub_C40816
...
sub_C40816:
    ...
    CLC
    ADC #0x10
    STA a:addr(bg3_tilemap+0xA0)
    LDA a:addr(level_manager_object.anonymous_10+1)
    AND #0xF
    ASL A
    TAX
    LDA f:hud_digits_tilenos_upper, X
...
.loc_C408E6:
    ...
    CMP #0x1C
    BNE .loc_C40934
    LDA a:addr(player_1.hit_flags)
    BIT #1
    BNE .loc_C40934
    REP #0x20
    LDA #addr(player_death)
    STA a:addr(player_1+object.handler)
    SEP #0x20
    LDA #bank(player_death)
    STA a:addr(player_1+object.handler+2)
    REP #0x20
...
.loc_C40934:
    ...
    CMP #0x1C
    BNE .loc_C40953
    LDA a:addr(player_2.hit_flags)
    BIT #1
    BNE .loc_C40953
    REP #0x20
    LDA #addr(player_death)
    STA a:addr(player_2+object.handler)
    SEP #0x20
    LDA #bank(player_death)
    STA a:addr(player_2+object.handler+2)

.loc_C40953:
    REP #0x20
    LDA #addr(hud_related_handler)
    STA $az:0, X
    SEP #0x20
    LDA #bank(hud_related_handler)
    STA $az:2, X
...
.loc_C409A0:
    ...
    LSR A
    ROL a:addr(joypad_1)
    ROL a:addr(joypad_1+1)
    LDA a:JOYSER1
    LSR A
    ROL a:addr(joypad_2)
    ROL a:addr(joypad_2+1)
    LSR A
    ROL a:addr(joypad_3)
    ROL a:addr(joypad_3+1)
    DEX
    BNE .loc_C409A0
    LDA a:JOYSER0
    AND #1
...
.loc_C409DE:
    ...
    LSR A
    ROL a:addr(joypad_4)
    ROL a:addr(joypad_4+1)
    LSR A
    ROL a:addr(joypad_5)
    ROL a:addr(joypad_5+1)
    DEX
    BNE .loc_C409DE
    LDA a:JOYSER1
    LSR A
...
animation_frame_C40BF4:
    ...
    frame_oam_tile   -8,  -17, 0x0600, 0x20
    frame_oam_tile    0,   -1, 0x2700, 0x00
    frame_oam_tile   -8,   -1, 0x2600, 0x00
    .end
animation_frame_C40C04:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x2101, 0x00
    frame_oam_tile   -8,    0, 0x2001, 0x00
    frame_oam_tile   -8,  -16, 0x0001, 0x20
    .end
animation_frame_C40C14:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x2301, 0x00
    frame_oam_tile   -8,    0, 0x2201, 0x00
    frame_oam_tile   -8,  -16, 0x0201, 0x20
    .end
animation_frame_C40C24:
    animation_frame_tile_count
    frame_oam_tile   -8,   -8, 0x0202, 0x20
    frame_oam_tile    0,  -16, 0x3300, 0x00
    frame_oam_tile   -8,  -16, 0x3200, 0x00
    .end
animation_frame_C40C34:
    animation_frame_tile_count
    frame_oam_tile    0,  -16, 0x3500, 0x00
    frame_oam_tile   -8,  -16, 0x3400, 0x00
    frame_oam_tile   -8,   -8, 0x0402, 0x20
    .end
animation_frame_C40C44:
    animation_frame_tile_count
    frame_oam_tile   -8,   -8, 0x0602, 0x20
    frame_oam_tile    0,  -16, 0x3700, 0x00
    frame_oam_tile   -8,  -16, 0x3600, 0x00
    .end
animation_frame_C40C54:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x2300, 0x00
    frame_oam_tile   -8,    0, 0x2200, 0x00
    frame_oam_tile   -8,  -16, 0x0200, 0x20
    .end
animation_frame_C40C64:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x2100, 0x00
    frame_oam_tile   -8,    0, 0x2000, 0x00
    frame_oam_tile   -8,  -16, 0x0000, 0x20
    .end
animation_frame_C40C74:
    animation_frame_tile_count
    frame_oam_tile   -8,  -16, 0x0400, 0x20
    frame_oam_tile    0,    0, 0x2500, 0x00
    frame_oam_tile   -8,    0, 0x2400, 0x00
    .end
animation_frame_C40C84:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x2501, 0x00
    frame_oam_tile   -8,    0, 0x2401, 0x00
    frame_oam_tile   -8,  -16, 0x0401, 0x20
    .end
animation_frame_C40C94:
    animation_frame_tile_count
    frame_oam_tile   -8,  -16, 0x0601, 0x20
...
animation_frame_C40CA4:
    ...
    frame_oam_tile    0,  -16, 0x3100, 0x00
    frame_oam_tile   -8,  -16, 0x3000, 0x00
    .end
animation_frame_C40CB4:
    animation_frame_tile_count
    frame_oam_tile   -8,   -8, 0x0003, 0x20
    frame_oam_tile    0,  -16, 0x3101, 0x00
    frame_oam_tile   -8,  -16, 0x3001, 0x00
    .end
animation_frame_C40CC4:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x1103, 0x00
    frame_oam_tile   -8,    0, 0x1003, 0x00
    frame_oam_tile   -8,  -16, 0x0403, 0x20
    .end
animation_frame_C40CD4:
    animation_frame_tile_count
    frame_oam_tile   -8,  -16, 0x0403, 0x00
    frame_oam_tile    0,  -16, 0x0503, 0x00
    frame_oam_tile    0,   -8, 0x1703, 0x00
    frame_oam_tile   -8,   -8, 0x1603, 0x00
    frame_oam_tile    0,    0, 0x1103, 0x00
    frame_oam_tile   -8,    0, 0x1003, 0x00
    .end
animation_frame_C40CF3:
    ...
    frame_oam_tile    0,  -16, 0x0503, 0x00
    frame_oam_tile   -8,  -16, 0x0403, 0x00
    frame_oam_tile    0,   -8, 0x3102, 0x00
    frame_oam_tile   -8,   -8, 0x3002, 0x00
    frame_oam_tile    0,    0, 0x1103, 0x00
    frame_oam_tile   -8,    0, 0x1003, 0x00
    .end
animation_frame_C40D12:
    ...
    frame_oam_tile    0,  -16, 0x3301, 0x00
    frame_oam_tile   -8,  -16, 0x3201, 0x00
    .end
animation_frame_C40D22:
    animation_frame_tile_count
    frame_oam_tile   -8,  -18, 0x2602, 0x20
    frame_oam_tile    0,   -2, 0x3502, 0x00
    frame_oam_tile   -8,   -2, 0x3402, 0x00
    .end
animation_frame_C40D32:
    animation_frame_tile_count
    frame_oam_tile   -5,  -16, 0x3200, 0x00
    frame_oam_tile   -5,   -8, 0x3202, 0x00
    frame_oam_tile    3,   -8, 0x3302, 0x00
    frame_oam_tile    3,  -16, 0x2302, 0x00
    frame_oam_tile   -5,    0, 0x2402, 0x00
    frame_oam_tile    3,    0, 0x2502, 0x00
    .end
animation_frame_C40D51:
    animation_frame_tile_count
    frame_oam_tile    0,    1, 0x2103, 0x00
    frame_oam_tile   -8,    1, 0x2003, 0x00
    frame_oam_tile   -8,  -15, 0x2203, 0x20
    .end
animation_frame_C40D61:
    animation_frame_tile_count
    frame_oam_tile   -3,  -16, 0x3200, 0x40
    frame_oam_tile   -3,   -8, 0x3202, 0x40
    frame_oam_tile  -11,  -16, 0x2302, 0x40
    frame_oam_tile  -11,   -8, 0x3302, 0x40
    frame_oam_tile   -3,    0, 0x2402, 0x40
    frame_oam_tile  -11,    0, 0x2502, 0x40
    .end
animation_frame_C40D80:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x2300, 0x00
    frame_oam_tile   -8,    0, 0x2200, 0x00
    frame_oam_tile    0,  -16, 0x3501, 0x00
    frame_oam_tile   -8,  -16, 0x3401, 0x00
    frame_oam_tile    0,   -8, 0x3701, 0x00
    frame_oam_tile   -8,   -8, 0x3601, 0x00
    .end
animation_frame_C40D9F:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x1302, 0x00
    frame_oam_tile   -8,    0, 0x1202, 0x00
    frame_oam_tile   -8,   -8, 0x0202, 0x00
    frame_oam_tile   -8,  -16, 0x3200, 0x00
    frame_oam_tile    0,   -8, 0x3103, 0x00
    frame_oam_tile    0,  -16, 0x3003, 0x00
    .end
animation_frame_C40DBE:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x1202, 0x40
    frame_oam_tile    0,   -8, 0x0202, 0x40
    frame_oam_tile    0,  -16, 0x3200, 0x40
    frame_oam_tile   -8,    0, 0x1302, 0x40
    frame_oam_tile   -8,   -8, 0x3103, 0x40
    frame_oam_tile   -8,  -16, 0x3003, 0x40
    .end
animation_frame_C40DDD:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x2104, 0x00
    frame_oam_tile   -8,    0, 0x2004, 0x00
    frame_oam_tile   -8,  -16, 0x0004, 0x20
    .end
animation_frame_C40DED:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x2304, 0x00
    frame_oam_tile   -8,    0, 0x2204, 0x00
    frame_oam_tile   -8,  -16, 0x0204, 0x20
    .end
animation_frame_C40DFD:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x2504, 0x00
    frame_oam_tile   -8,    0, 0x2404, 0x00
    frame_oam_tile   -8,  -16, 0x0404, 0x20
    .end
animation_frame_C40E0D:
    animation_frame_tile_count
    frame_oam_tile   -8,   -8, 0x0604, 0x20
    .end
...
animation_frame_C40E19:
    animation_frame_tile_count
    frame_oam_tile   -8,   -8, 0x0005, 0x20
    .end
animation_frame_C40E1F:
    animation_frame_tile_count
    frame_oam_tile   -8,    0, 0x3404, 0x00
    frame_oam_tile    0,    0, 0x3504, 0x00
    .end
animation_frame_C40E2A:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x3104, 0x00
    frame_oam_tile   -8,    0, 0x3004, 0x00
    .end
animation_frame_C40E35:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x3304, 0x00
    frame_oam_tile   -8,    0, 0x3204, 0x00
    .end
animation_frame_C40E40:
    animation_frame_tile_count
    frame_oam_tile   -8,  -16, 0x0400, 0x20
    frame_oam_tile   -8,    0, 0x2400, 0x20
    frame_oam_tile    0,    0, 0x1200, 0x40
    frame_oam_tile   -8,    0, 0x1200, 0x00
    .end
animation_frame_C40E55:
    animation_frame_tile_count
    frame_oam_tile   -8,  -16, 0x0600, 0x20
    frame_oam_tile   -8,    0, 0x2600, 0x20
    frame_oam_tile    0,    0, 0x1200, 0x40
    frame_oam_tile   -8,    0, 0x1200, 0x00
    .end
animation_frame_C40E6A:
    animation_frame_tile_count
    frame_oam_tile   -8,  -18, 0x2200, 0x20
    frame_oam_tile   -8,   -2, 0x2000, 0x20
    frame_oam_tile    0,    0, 0x1200, 0x40
    frame_oam_tile   -8,    0, 0x1200, 0x00
    .end
animation_frame_C40E7F:
    animation_frame_tile_count
    frame_oam_tile   -8,  -20, 0x2200, 0x20
    frame_oam_tile   -8,   -4, 0x2000, 0x20
    frame_oam_tile   -8,    0, 0x0200, 0x40
    frame_oam_tile    0,    0, 0x0200, 0x00
    .end
animation_frame_C40E94:
    animation_frame_tile_count
    frame_oam_tile   -8,  -23, 0x2200, 0x20
    frame_oam_tile   -8,   -7, 0x2000, 0x20
    frame_oam_tile   -8,    0, 0x0200, 0x40
    frame_oam_tile    0,    0, 0x0200, 0x00
    .end
animation_frame_C40EA9:
    animation_frame_tile_count
    frame_oam_tile   -8,  -26, 0x2200, 0x20
    frame_oam_tile   -8,  -10, 0x2000, 0x20
    frame_oam_tile   -4,    0, 0x0300, 0x00
    .end
animation_frame_C40EB9:
    animation_frame_tile_count
    frame_oam_tile   -8,  -29, 0x2200, 0x20
    frame_oam_tile   -8,  -13, 0x2000, 0x20
    frame_oam_tile   -4,    0, 0x0300, 0x00
    .end
animation_frame_C40EC9:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x2002, 0x40
    frame_oam_tile    0,  -35, 0x0703, 0x00
    frame_oam_tile   -8,  -35, 0x0603, 0x00
    frame_oam_tile   -8,    0, 0x2002, 0x00
    frame_oam_tile    0,  -51, 0x3501, 0x00
    frame_oam_tile   -8,  -51, 0x3401, 0x00
    frame_oam_tile    0,  -43, 0x3701, 0x00
    frame_oam_tile   -8,  -43, 0x3601, 0x00
    .end
animation_frame_C40EF2:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x2002, 0x40
    frame_oam_tile    0,  -33, 0x0703, 0x00
    frame_oam_tile   -8,  -33, 0x0603, 0x00
    frame_oam_tile   -8,    0, 0x2002, 0x00
    frame_oam_tile    0,  -49, 0x3501, 0x00
    frame_oam_tile   -8,  -49, 0x3401, 0x00
    frame_oam_tile    0,  -41, 0x3701, 0x00
    frame_oam_tile   -8,  -41, 0x3601, 0x00
    .end
animation_frame_C40F1B:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x2002, 0x40
    frame_oam_tile    0,  -28, 0x0703, 0x00
    frame_oam_tile   -8,  -28, 0x0603, 0x00
    frame_oam_tile   -8,    0, 0x2002, 0x00
    frame_oam_tile    0,  -44, 0x3501, 0x00
    frame_oam_tile   -8,  -44, 0x3401, 0x00
    frame_oam_tile    0,  -36, 0x3701, 0x00
    frame_oam_tile   -8,  -36, 0x3601, 0x00
    .end
animation_frame_C40F44:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x2002, 0x40
    frame_oam_tile    0,  -24, 0x0703, 0x00
    frame_oam_tile   -8,  -24, 0x0603, 0x00
    frame_oam_tile   -8,    0, 0x2002, 0x00
    frame_oam_tile    0,  -40, 0x3501, 0x00
    frame_oam_tile   -8,  -40, 0x3401, 0x00
    frame_oam_tile    0,  -32, 0x3701, 0x00
    frame_oam_tile   -8,  -32, 0x3601, 0x00
    .end
animation_frame_C40F6D:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x2002, 0x40
    frame_oam_tile    0,  -20, 0x0703, 0x00
    frame_oam_tile   -8,  -20, 0x0603, 0x00
    frame_oam_tile   -8,    0, 0x2002, 0x00
    frame_oam_tile    0,  -36, 0x3501, 0x00
    frame_oam_tile   -8,  -36, 0x3401, 0x00
    frame_oam_tile    0,  -28, 0x3701, 0x00
    frame_oam_tile   -8,  -28, 0x3601, 0x00
    .end
animation_frame_C40F96:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x2002, 0x40
    frame_oam_tile    0,  -17, 0x0703, 0x00
    frame_oam_tile   -8,  -17, 0x0603, 0x00
    frame_oam_tile   -8,    0, 0x2002, 0x00
    frame_oam_tile    0,  -33, 0x3501, 0x00
    frame_oam_tile   -8,  -33, 0x3401, 0x00
    frame_oam_tile    0,  -25, 0x3701, 0x00
    frame_oam_tile   -8,  -25, 0x3601, 0x00
    .end
animation_frame_C40FBF:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x2002, 0x40
    frame_oam_tile    0,  -13, 0x0703, 0x00
    frame_oam_tile   -8,  -13, 0x0603, 0x00
    frame_oam_tile   -8,    0, 0x2002, 0x00
    frame_oam_tile    0,  -29, 0x3501, 0x00
    frame_oam_tile   -8,  -29, 0x3401, 0x00
    frame_oam_tile    0,  -21, 0x3701, 0x00
    frame_oam_tile   -8,  -21, 0x3601, 0x00
    .end
animation_frame_C40FE8:
    animation_frame_tile_count
    frame_oam_tile    0,    0, 0x2002, 0x40
    frame_oam_tile    0,   -9, 0x0703, 0x00
    frame_oam_tile   -8,   -9, 0x0603, 0x00
    frame_oam_tile   -8,    0, 0x2002, 0x00
    frame_oam_tile    0,  -25, 0x3501, 0x00
    frame_oam_tile   -8,  -25, 0x3401, 0x00
    frame_oam_tile    0,  -17, 0x3701, 0x00
    frame_oam_tile   -8,  -17, 0x3601, 0x00
    .end
animation_frame_C41011:
    animation_frame_tile_count
    frame_oam_tile   -4,   -4, 0x2102, 0x00
    .end
animation_frame_C41017:
    animation_frame_tile_count
    frame_oam_tile   -1,  -10, 0x2202, 0x00
    frame_oam_tile   -5,  -10, 0x2202, 0x00
    frame_oam_tile   -8,   -8, 0x0203, 0x20
    frame_oam_tile    0,  -16, 0x3301, 0x00
    frame_oam_tile   -8,  -16, 0x3201, 0x00
    .end
...
.loc_C41212:
    ...
    set_handler handle_player_movement
    RTL
...
play_hit_by_bomb_animation:
    ...
    STA z:player.effective_palette, X
    REP #0x20
    start_animation #addr(hit_by_bomb_animation)
    set_handler _play_hit_by_bomb_animation
...
i16
    ...
    STA z:player.y_position, X
    REP #0x20
    start_animation #addr(enter_warp_animation)
    set_handler _enter_warp

_enter_warp:
    JSL render_sprite_animated
    BCC .locret_C41612
    set_handler warp_delay
...
play_exit_warp_animation:
    REP #0x20
    start_animation #addr(unknown_animation)
    set_handler _play_exit_warp_animation
...
.loc_C416B6:
    ...
    STA z:player.y_position, X
    STZ a:0x12f, X
    set_handler play_exit_warp_animation
...
trampoline_delay:
    ...
    LDA #0x30
    STA z:player.trampoline_state, X
    set_handler _trampoline_delay

_trampoline_delay:
    REP #0x20
    DEC z:player.trampoline_state, X
    BNE .locret_C41776
    set_handler trampoline_land
...
.loc_C41804:
    set_handler handle_player_movement_1
    JSL load_animation_frame
    RTL
...
.loc_C41934:
    ...
    BNE .locret_C41947
    SEP #0x20
    LDA a:addr(level_manager_object.current_screen)
    BNE .locret_C41947
    INC a:addr(level_manager_object.current_screen)
    INC a:addr(current_screen)
...
last_human_death:
    PHX
    REP #0x20
    LDA a:addr(level_manager_object.number_of_ai_players)
    INC A
    AND #0xFF
    TAX
    JSL random
...
.loc_C41966:
    LDA a:player.unknown_flags, Y
    BEQ .loc_C41982
    LDA a:player.is_ai, Y
    BEQ .loc_C41982
    LDA #0
    STA a:player.lives, Y
    LDA z:0x42
    INC z:0x42
    CMP z:0x40
    BNE .loc_C41982
...
i16
    ...
    JSL sub_C44945
    SEP #0x20
    DEC a:addr(level_manager_object.number_of_human_players)
    DEC a:addr(level_manager_object.enemy_count)
    LDA a:addr(level_manager_object.number_of_human_players)
    BNE .loc_C419BB
...
.loc_C419BB:
    ...
    STA z:0x12, X
    REP #0x20
    start_animation #addr(death_animation)
    set_handler _player_death
...
sub_C41A40:
    ...
    STA a:addr(story_mode_timers), Y
    SEP #0x20
    DEC a:addr(level_manager_object.unknown_flags)
    STZ z:4, X
    RTL
...
.loc_C41E8E:
    JSL sub_C423BD
    JMP a:handle_player_movement.inner
...
create_bonus_object:
    ...
    LDA #0
    STA a:0x14, Y
    INC a:addr(number_of_visible_bonuses)
...
.loc_C424FC:
    REP #0x20
    DEC a:addr(number_of_visible_bonuses)
    JSL delete_object
    RTL
...
.loc_C42856:
    ...
    PHX
    TAX
    LDA f:enemy_scores, X
    STA z:0x42
    LDA f:enemy_scores+2, X
    STA z:0x40
    PLX
...
animation_frame_C4294B:
    animation_frame_tile_count
    frame_oam_tile   -8,   -8, 0x0000, 0x20
    .end
animation_frame_C42951:
    animation_frame_tile_count
    frame_oam_tile   -8,   -8, 0x0200, 0x20
    .end
animation_frame_C42957:
    animation_frame_tile_count
    frame_oam_tile   -8,   -8, 0x0400, 0x20
    .end
...
animation_frame_C429B8:
    animation_frame_tile_count
    frame_oam_tile   24,  -16, 0x0000, 0x20
    frame_oam_tile  -40,  -16, 0x0000, 0x20
    .end
animation_frame_C429C3:
    animation_frame_tile_count
    frame_oam_tile   23,  -16, 0x0000, 0x20
    frame_oam_tile  -39,  -16, 0x0000, 0x20
    .end
animation_frame_C429CE:
    animation_frame_tile_count
    frame_oam_tile   22,  -16, 0x0000, 0x20
    frame_oam_tile  -38,  -16, 0x0000, 0x20
    .end
animation_frame_C429D9:
    animation_frame_tile_count
    frame_oam_tile   21,  -16, 0x0000, 0x20
    frame_oam_tile  -37,  -16, 0x0000, 0x20
    .end
animation_frame_C429E4:
    animation_frame_tile_count
    frame_oam_tile   20,  -16, 0x0000, 0x20
    frame_oam_tile  -36,  -16, 0x0000, 0x20
    .end
animation_frame_C429EF:
    animation_frame_tile_count
    frame_oam_tile   19,  -16, 0x0000, 0x20
    frame_oam_tile  -35,  -16, 0x0000, 0x20
    .end
animation_frame_C429FA:
    animation_frame_tile_count
    frame_oam_tile   18,  -16, 0x0000, 0x20
    frame_oam_tile  -34,  -16, 0x0000, 0x20
    .end
animation_frame_C42A05:
    animation_frame_tile_count
    frame_oam_tile   17,  -16, 0x0000, 0x20
    frame_oam_tile  -33,  -16, 0x0000, 0x20
    .end
animation_frame_C42A10:
    animation_frame_tile_count
    frame_oam_tile   16,  -16, 0x0000, 0x20
    frame_oam_tile  -32,  -16, 0x0000, 0x20
    .end
animation_frame_C42A1B:
    animation_frame_tile_count
    frame_oam_tile   15,  -16, 0x0000, 0x20
    frame_oam_tile  -31,  -16, 0x0000, 0x20
    .end
animation_frame_C42A26:
    animation_frame_tile_count
    frame_oam_tile   14,  -16, 0x0000, 0x20
    frame_oam_tile  -30,  -16, 0x0000, 0x20
    .end
animation_frame_C42A31:
    animation_frame_tile_count
    frame_oam_tile   13,  -16, 0x0000, 0x20
    frame_oam_tile  -29,  -16, 0x0000, 0x20
    .end
animation_frame_C42A3C:
    animation_frame_tile_count
    frame_oam_tile   12,  -16, 0x0000, 0x20
    frame_oam_tile  -28,  -16, 0x0000, 0x20
    .end
animation_frame_C42A47:
    animation_frame_tile_count
    frame_oam_tile   11,  -16, 0x0000, 0x20
    frame_oam_tile  -27,  -16, 0x0000, 0x20
    .end
animation_frame_C42A52:
    animation_frame_tile_count
    frame_oam_tile   10,  -16, 0x0000, 0x20
    frame_oam_tile  -26,  -16, 0x0000, 0x20
    .end
animation_frame_C42A5D:
    animation_frame_tile_count
    frame_oam_tile    9,  -16, 0x0000, 0x20
    frame_oam_tile  -25,  -16, 0x0000, 0x20
    .end
animation_frame_C42A68:
    animation_frame_tile_count
    frame_oam_tile    8,  -16, 0x0000, 0x20
    frame_oam_tile  -24,  -16, 0x0000, 0x20
    frame_oam_tile    8,  -16, 0x0200, 0x40
    frame_oam_tile    8,   -8, 0x1200, 0x40
    frame_oam_tile  -16,   -8, 0x1200, 0x00
    frame_oam_tile  -16,  -16, 0x0200, 0x00
    .end
animation_frame_C42A87:
    animation_frame_tile_count
    frame_oam_tile    8,  -16, 0x0000, 0x20
    frame_oam_tile  -24,  -16, 0x0000, 0x20
    frame_oam_tile    7,  -16, 0x0200, 0x40
    frame_oam_tile    7,   -8, 0x1200, 0x40
    frame_oam_tile  -15,   -8, 0x1200, 0x00
    frame_oam_tile  -15,  -16, 0x0200, 0x00
    .end
animation_frame_C42AA6:
    animation_frame_tile_count
    frame_oam_tile    8,  -16, 0x0000, 0x20
    frame_oam_tile  -24,  -16, 0x0000, 0x20
    frame_oam_tile    6,  -16, 0x0200, 0x40
    frame_oam_tile    6,   -8, 0x1200, 0x40
    frame_oam_tile  -14,   -8, 0x1200, 0x00
    frame_oam_tile  -14,  -16, 0x0200, 0x00
    .end
animation_frame_C42AC5:
    animation_frame_tile_count
    frame_oam_tile    8,  -16, 0x0000, 0x20
    frame_oam_tile  -24,  -16, 0x0000, 0x20
    frame_oam_tile    5,  -16, 0x0200, 0x40
    frame_oam_tile    5,   -8, 0x1200, 0x40
    frame_oam_tile  -13,   -8, 0x1200, 0x00
    frame_oam_tile  -13,  -16, 0x0200, 0x00
    .end
animation_frame_C42AE4:
    animation_frame_tile_count
    frame_oam_tile    8,  -16, 0x0000, 0x20
    frame_oam_tile  -24,  -16, 0x0000, 0x20
    frame_oam_tile    4,  -16, 0x0200, 0x40
    frame_oam_tile    4,   -8, 0x1200, 0x40
    frame_oam_tile  -12,   -8, 0x1200, 0x00
    frame_oam_tile  -12,  -16, 0x0200, 0x00
    .end
animation_frame_C42B03:
    animation_frame_tile_count
    frame_oam_tile    8,  -16, 0x0000, 0x20
    frame_oam_tile  -24,  -16, 0x0000, 0x20
    frame_oam_tile    3,  -16, 0x0200, 0x40
    frame_oam_tile    3,   -8, 0x1200, 0x40
    frame_oam_tile  -11,   -8, 0x1200, 0x00
    frame_oam_tile  -11,  -16, 0x0200, 0x00
    .end
animation_frame_C42B22:
    animation_frame_tile_count
    frame_oam_tile    8,  -16, 0x0000, 0x20
    frame_oam_tile  -24,  -16, 0x0000, 0x20
    frame_oam_tile    2,  -16, 0x0200, 0x40
    frame_oam_tile    2,   -8, 0x1200, 0x40
    frame_oam_tile  -10,   -8, 0x1200, 0x00
    frame_oam_tile  -10,  -16, 0x0200, 0x00
    .end
animation_frame_C42B41:
    animation_frame_tile_count
    frame_oam_tile    8,  -16, 0x0000, 0x20
    frame_oam_tile  -24,  -16, 0x0000, 0x20
    frame_oam_tile    1,  -16, 0x0200, 0x40
    frame_oam_tile    1,   -8, 0x1200, 0x40
    frame_oam_tile   -9,   -8, 0x1200, 0x00
    frame_oam_tile   -9,  -16, 0x0200, 0x00
    .end
animation_frame_C42B60:
    animation_frame_tile_count
    frame_oam_tile    8,  -16, 0x0000, 0x20
    frame_oam_tile  -24,  -16, 0x0000, 0x20
    frame_oam_tile    0,  -16, 0x0200, 0x40
    frame_oam_tile    0,   -8, 0x1200, 0x40
    frame_oam_tile   -8,   -8, 0x1200, 0x00
...
.loc_C42C8B:
    ...
    LDA #0x808
    STA z:0x1E, X
    start_animation #addr(down_walking_animation)
    set_handler .loc_C42CDF
    SEP #0x20
    LDA a:addr(level_manager_object.level_representation)
    CMP #0x58
    BNE .loc_C42CDF
...
sub_C42D0C:
    ...
    BIT #GAME_FLAGS_BATTLE_DELAY
    BNE .loc_C42D22
    set_handler handle_player_movement_0
...
.loc_C42D6B:
    set_handler sub_C42C4B.loc_C42CDF
...
i16
    ...
    REP #0x20
    start_animation #addr(enter_warp_animation)
    set_handler .loc_C42F97

.loc_C42F97:
    JSL render_sprite_animated
    BCC .locret_C42FAA
    set_handler sub_C42FAB
...
.loc_C42FBE:
    ...
    DEC z:0x10, X
    BNE .ret
    set_handler sub_C42FE7.loc_C4302A
...
.loc_C430EB:
    ...
    REP #0x20
    REP #0x20
    start_animation_far death_animation
    set_handler .loc_C4311B
    SEP #0x20
    DEC a:addr(level_manager_object.number_of_ai_players)
    DEC a:addr(level_manager_object.enemy_count)
...
.loc_C435C4:
    start_animation #addr(byte_C42B7F)
    set_handler .loc_C43648
    RTL
...
.loc_C435EE:
    start_animation #addr(byte_C42BE5)
    set_handler .loc_C4360A
...
.loc_C43673:
    start_animation #addr(byte_C42B84)
    set_handler .loc_C4368F
...
.loc_C4368F:
    ...
    LDA #0
    STA a:0x30, Y
    start_animation #addr(byte_C42C46)
    set_handler .loc_C435E1
    RTL
.loc_C436BC:
    JSL render_sprite_animated
...
arena_level_initializer:
    ...
    SEP #0x20
    LDA #0xFF
    STA a:addr(level_manager_object.number_of_human_players)
    REP #0x20
    LDA #0x10
    STA a:0x10, Y
    LDA #0
...
.loc_C4374D:
    ...
    BNE arena_level_initializer.locret_C436FC
    SEP #0x20
    INC a:addr(level_manager_object.level_representation)
    INC a:addr(level_manager_object.fade_related_)
    INC a:addr(current_screen)
...
.loc_C43818:
    ...
    BNE .ret
    LDA a:addr(game_flags)
    AND #low(~GAME_FLAGS_BATTLE_DELAY)
    STA a:addr(game_flags)
    set_handler mecha_bomberman_related

.ret:
    RTL

.loc_C4384A:
    set_handler .loc_C4385E
    REP #0x20
    LDA #0x180
    STA z:0x10, X
...
.loc_C439D5:
    LDA #0xA
    STA a:addr(bg1_tilemap+2)
    STA a:addr(bg1_tilemap+4)
    STA a:addr(bg1_tilemap+6)
    STA a:addr(bg1_tilemap+8)
    STA a:addr(bg1_tilemap+0xA)
    STA a:addr(bg1_tilemap+0x42)
    STA a:addr(bg1_tilemap+0x44)
    STA a:addr(bg1_tilemap+0x46)
    STA a:addr(bg1_tilemap+0x48)
    STA a:addr(bg1_tilemap+0x4A)
    STA a:addr(bg1_tilemap+0x16)
    STA a:addr(bg1_tilemap+0x18)
    STA a:addr(bg1_tilemap+0x1A)
    STA a:addr(bg1_tilemap+0x1C)
    STA a:addr(bg1_tilemap+0x1E)
    STA a:addr(bg1_tilemap+0x56)
    STA a:addr(bg1_tilemap+0x58)
    STA a:addr(bg1_tilemap+0x5A)
    STA a:addr(bg1_tilemap+0x5C)
    STA a:addr(bg1_tilemap+0x5E)
    LDA #0x2E
    STA a:addr(bg1_tilemap)
    STA a:addr(bg1_tilemap+0x40)
    STA a:addr(bg1_tilemap+0x80)
    STA a:addr(bg1_tilemap+0xC0)
    STA a:addr(bg1_tilemap+0x100)
    STA a:addr(bg1_tilemap+0x140)
    STA a:addr(bg1_tilemap+0x180)
    STA a:addr(bg1_tilemap+0x1C0)
    STA a:addr(bg1_tilemap+0x200)
    STA a:addr(bg1_tilemap+0x240)
    STA a:addr(bg1_tilemap+0x280)
    STA a:addr(bg1_tilemap+0x2C0)
    STA a:addr(bg1_tilemap+0x300)
    STA a:addr(bg1_tilemap+0x20)
    STA a:addr(bg1_tilemap+0x60)
    STA a:addr(bg1_tilemap+0xA0)
    STA a:addr(bg1_tilemap+0xE0)
    STA a:addr(bg1_tilemap+0x120)
    STA a:addr(bg1_tilemap+0x160)
    STA a:addr(bg1_tilemap+0x1A0)
    STA a:addr(bg1_tilemap+0x1E0)
    STA a:addr(bg1_tilemap+0x220)
    STA a:addr(bg1_tilemap+0x260)
    STA a:addr(bg1_tilemap+0x2A0)
    STA a:addr(bg1_tilemap+0x2E0)
    STA a:addr(bg1_tilemap+0x320)
    LDA #0x2A
    STA a:addr(bg1_tilemap+0x82)
    STA a:addr(bg1_tilemap+0x9E)
    RTL
...
.loc_C4406D:
    LDA a:addr(collision_map - 0x40), Y
    ORA a:addr(collision_map + 2), Y
    ORA a:addr(collision_map + 0x40), Y
    ORA a:addr(collision_map - 2), Y
    BIT #POTENTIAL_BLAST
    BNE .loc_C44080
    CLC
...
.loc_C44483:
    ...
    TYA
    AND #0x3C0
    CMP a:addr(number_of_musics_in_bank),X
    SEP #0x20
    BCS .loc_C444A0
    SEC
    RTL
...
.loc_C44840:
    REP #0x20
    LDY a:addr(dboot_ram_start),X
    LDA a:0x11, Y
    AND #0xF0
    LSR A
    LSR A
    LSR A
    STA a:addr(number_of_sounds),X
    LDA a:0x14, Y
    AND #0xF0
    ASL A
    ASL A
...
sub_C44945:
    SEP #0x20
    CLC
    LDA a:addr(dboot_paramater_0),X
    ADC a:addr(unk_dboot_31),X
    ADC a:addr(unk_dboot_32),X
    ADC a:addr(unk_dboot_33),X
    ADC a:addr(unk_dboot_34),X
    ADC a:addr(unk_dboot_35),X
    STA z:0x40
    BEQ .locret_C44997
    SEP #0x20
...
.loc_C449CF:
    ...
    TAY
    SEP #0x20
    LDA a:addr(dboot_paramater_0), Y
    BNE .loc_C449E1
    INC z:0x34,X
    BRA .loc_C449CF
...
.loc_C449E1:
    DEC A
    STA a:addr(dboot_paramater_0), Y
    REP #0x20
    LDA z:0x34,X
    ASL A
    PHX
...
.loc_C44C48:
    ...
    CPX #addr(player_4 + player.sizeof)
    BCS .loc_C44C74
    INC a:addr(unk_dboot_8),X
    LDA a:addr(unk_dboot_8),X
    STA a:0x1C, Y
...
.loc_C44F3B:
    CPY #addr(gameover_related_object)
    BCS .ret
    LDA a:7, Y
    BEQ .ret
    DEC z:0xD,X
...
animation_frame_C4608A:
    ...
    frame_oam_tile   -8,    0, 0x0102, 0x20
    frame_oam_tile   -8,  -16, 0x2100, 0x20
    frame_oam_tile  -16,  -16, 0x2000, 0x00
    frame_oam_tile    0,  -24, 0x1200, 0x00
    frame_oam_tile    0,  -32, 0x0200, 0x00
    frame_oam_tile  -16,  -32, 0x0000, 0x20
    .end
animation_frame_C460B3:
    animation_frame_tile_count
    frame_oam_tile    0,   16, 0x2602, 0x20
    frame_oam_tile  -16,   16, 0x2402, 0x20
    frame_oam_tile    0,    0, 0x0602, 0x20
    frame_oam_tile  -16,    0, 0x0402, 0x20
    frame_oam_tile    0,  -16, 0x2600, 0x20
    frame_oam_tile  -16,  -16, 0x2400, 0x20
    frame_oam_tile    0,  -32, 0x0201, 0x20
    frame_oam_tile  -16,  -32, 0x0001, 0x20
    .end
animation_frame_C460DC:
    animation_frame_tile_count
    frame_oam_tile    0,   16, 0x2203, 0x20
    frame_oam_tile  -16,   16, 0x2003, 0x20
    frame_oam_tile    0,    0, 0x0203, 0x20
    frame_oam_tile  -16,    0, 0x0003, 0x20
    frame_oam_tile    0,  -16, 0x2201, 0x20
    frame_oam_tile  -16,  -16, 0x2001, 0x20
    frame_oam_tile    0,  -32, 0x0201, 0x20
    frame_oam_tile  -16,  -32, 0x0001, 0x20
    .end
animation_frame_C46105:
    animation_frame_tile_count
    frame_oam_tile    0,   16, 0x2603, 0x20
    frame_oam_tile  -16,   16, 0x2403, 0x20
    frame_oam_tile    0,    0, 0x0603, 0x20
    frame_oam_tile  -16,    0, 0x0403, 0x20
    frame_oam_tile    0,  -16, 0x2601, 0x20
    frame_oam_tile  -16,  -16, 0x2401, 0x20
    frame_oam_tile    0,  -32, 0x0601, 0x20
    frame_oam_tile  -16,  -32, 0x0401, 0x20
    .end
animation_frame_C4612E:
    animation_frame_tile_count
    frame_oam_tile    8,   24, 0x3303, 0x00
    frame_oam_tile    0,   24, 0x3203, 0x00
    frame_oam_tile   -8,   24, 0x3103, 0x00
    frame_oam_tile  -16,   24, 0x3003, 0x00
    frame_oam_tile    8,   16, 0x2306, 0x00
    frame_oam_tile    0,   16, 0x2206, 0x00
    frame_oam_tile   -8,   16, 0x2106, 0x00
    frame_oam_tile  -16,   16, 0x2006, 0x00
    frame_oam_tile    0,    0, 0x0206, 0x20
    frame_oam_tile  -16,    0, 0x0006, 0x20
    frame_oam_tile    0,  -16, 0x2204, 0x20
    frame_oam_tile  -16,  -16, 0x2004, 0x20
    frame_oam_tile    0,  -32, 0x0204, 0x20
    frame_oam_tile  -16,  -32, 0x0004, 0x20
    .end
animation_frame_C46175:
    animation_frame_tile_count
    frame_oam_tile    0,   16, 0x2607, 0x20
    frame_oam_tile  -16,   16, 0x2407, 0x20
    frame_oam_tile    0,    0, 0x0606, 0x20
    frame_oam_tile  -16,    0, 0x0406, 0x20
    frame_oam_tile    0,  -16, 0x2604, 0x20
    frame_oam_tile  -16,  -16, 0x2404, 0x20
    frame_oam_tile    0,  -32, 0x0604, 0x20
    frame_oam_tile  -16,  -32, 0x0404, 0x20
    .end
animation_frame_C4619E:
    animation_frame_tile_count
    frame_oam_tile    8,    0, 0x0307, 0x00
    frame_oam_tile    0,    0, 0x0207, 0x00
    frame_oam_tile    0,    8, 0x2207, 0x00
    frame_oam_tile   -8,   16, 0x2107, 0x20
    frame_oam_tile   -8,    8, 0x1107, 0x00
    frame_oam_tile   -8,    0, 0x0107, 0x00
    frame_oam_tile    0,  -16, 0x2205, 0x20
    frame_oam_tile   -8,   -8, 0x3105, 0x00
    frame_oam_tile   -8,  -16, 0x2105, 0x00
    frame_oam_tile  -16,  -16, 0x2005, 0x00
    frame_oam_tile    0,  -32, 0x0205, 0x20
    frame_oam_tile  -16,  -32, 0x0005, 0x20
    .end
animation_frame_C461DB:
    animation_frame_tile_count
    frame_oam_tile    0,   16, 0x2607, 0x20
    frame_oam_tile  -16,   16, 0x2407, 0x20
    frame_oam_tile    0,    0, 0x0607, 0x20
    frame_oam_tile  -16,    0, 0x0407, 0x20
    frame_oam_tile    0,  -16, 0x2605, 0x20
    frame_oam_tile  -16,  -16, 0x2405, 0x20
    frame_oam_tile    0,  -32, 0x0605, 0x20
    frame_oam_tile  -16,  -32, 0x0405, 0x20
    .end
animation_frame_C46204:
    animation_frame_tile_count
    frame_oam_tile    0,   -8, 0x2606, 0x20
    frame_oam_tile  -16,   -8, 0x2406, 0x20
    .end
animation_frame_C4620F:
    animation_frame_tile_count
    frame_oam_tile   56,    8, 0x1002, 0x00
    frame_oam_tile   56,    0, 0x0002, 0x00
    frame_oam_tile   56,   -8, 0x3000, 0x00
    frame_oam_tile   40,    8, 0x3106, 0x00
    frame_oam_tile   32,    8, 0x3006, 0x00
    frame_oam_tile   32,   -8, 0x0500, 0x20
    frame_oam_tile   16,    8, 0x0302, 0x00
    frame_oam_tile   16,    0, 0x3300, 0x00
    frame_oam_tile   16,   -8, 0x2300, 0x00
    frame_oam_tile    8,    8, 0x3307, 0x00
    frame_oam_tile    8,    0, 0x2307, 0x00
    frame_oam_tile    8,   -8, 0x1307, 0x00
    frame_oam_tile   -8,    8, 0x2007, 0x00
    frame_oam_tile  -16,    8, 0x0007, 0x00
    frame_oam_tile   -8,    0, 0x1007, 0x00
    frame_oam_tile  -16,    0, 0x3005, 0x00
    frame_oam_tile   -8,   -8, 0x3306, 0x00
    frame_oam_tile  -16,   -8, 0x3206, 0x00
    frame_oam_tile  -32,    8, 0x3106, 0x00
    frame_oam_tile  -40,    8, 0x3006, 0x00
    frame_oam_tile  -56,    8, 0x1700, 0x00
    frame_oam_tile  -64,    8, 0x0700, 0x00
    frame_oam_tile  -40,   -8, 0x0500, 0x20
    frame_oam_tile  -64,   -8, 0x0300, 0x20
    .end
byte_C46288:
    animation_frame_count
...
i16
    REP #0x20
    LDA #0x5000
    STA a:addr(unk_7E0E5C)
    LDA #0
    STA a:addr(unk_7E0E5A)
    LDA #0x5000
    STA a:addr(unk_7E0E9C)
    LDA #0
    STA a:addr(unk_7E0E9A)
    SEP #0x20
    PHX
    LDX #addr(player_1)
    STZ z:6,X
...
sub_C463DE:
    ...
    STA a:addr(game_flags)
    STZ a:addr(level_manager_object.anonymous_9)
    RTL
...
.loc_C464C6:
    ...
    INC z:6,X
    LDA z:6,X
    STA a:addr(level_manager_object.anonymous_1)
    LDA z:5,X
    STA a:addr(level_manager_object.anonymous_1+1)
    JSL sub_C55C7F
    REP #0x20
    LDA #0x42D8
    STA z:0x40
    ...
    LDA #0xE
    JSL set_palette
    LDA f:palette_table+8
    STA z:0x40
    LDA #8
    JSL set_palette
    LDA f:palette_table+9
    STA z:0x40
    LDA #9
    JSL set_palette
    STZ a:addr(player_1.unknown_flags)
    STZ a:addr(player_2.unknown_flags)
    STZ a:addr(player_3.unknown_flags)
    STZ a:addr(player_4.unknown_flags)
    REP #0x20
    LDA #addr(.loc_C46582)
    STA z:0,X
    SEP #0x20
...
.loc_C46729:
    LDA #0x10
    STA a:addr(joypad_1_previous + 1), Y
    LDA #0
    STA a:addr(joypad_1_pressed), Y
    LDA #0
    STA a:addr(joypad_1_pressed + 1), Y
    PLY
...
.loc_C46744:
    ...
    STA a:0x1C, Y
    LDA #0x5000
    STA a:addr(unk_dboot_1C), Y
    LDA #0
    STA a:addr(current_music_bank), Y
    SEP #0x20
    PHY
    LDA a:5, Y
    STA z:0x40
...
.loc_C4678B:
    ...
    STZ z:7,X
    JSL draw_number_of_lives
    INC a:addr(level_manager_object.unknown_flags)
...
.loc_C467F1:
    ...
    PHX
    TAX
    LDA a:addr(joypad_1_previous),X
    PLX
    BIT #0xC0C0
    BEQ .loc_C46861
    LDA z:5,X
    ...
    INC a:addr(level_manager_object.unknown_flags)
    INC a:addr(level_manager_object.enemy_count)
    INC a:addr(level_manager_object.number_of_human_players)
...
sub_C46896:
    ...
    LDA #0x3FF
    STA a:addr(bg3_v_scroll)
    STZ a:addr(number_of_visible_bonuses)
    JSL stage_related_init
    SEP #0x20
    STZ a:addr(byte_7E0CA9)
    STZ a:addr(byte_7E0C3E)
    LDA #8
    STA a:addr(bg1_h_scroll)
    LDA #0
    STA a:addr(bg1_h_scroll+1)
    LDA #0
    STA a:addr(word_7E031A)
    LDY #0
    LDA #addr(BLACK_PALETTE)
...
i16
    ...
    STA z:0x50
    LDA f:[z:0x50]
    STA a:addr(level_manager_object.anonymous_5)
    INC z:0x50
    INC z:0x50
    LDX #0xD00
    LDA f:[z:0x50]
    STA a:addr(level_manager_object.spawn_and_flags)
    INC z:0x50
    INC z:0x50
    LDA f:[z:0x50]
    INC z:0x50
...
.loc_C46987:
    ...
    JSL count_level_bonuses
    JSL shuffle_and_divide_bonuses
    REP #0x20
    LDA #addr(shuffled_bonus_index_array)
    STA z:0x59
    SEP #0x20
    LDA #bank(shuffled_bonus_index_array)
    STA z:0x5B
...
.loc_C46B2A:
    ...
    LDA #3
    STA a:addr(bg1_v_scroll+1)
    LDA #0x20
    STA a:addr(level_manager_object.anonymous_6)
    LDY #4
    LDA #0
    STA z:0x40
    LDA #0
...
sub_C46DF1:
    ...
    STA a:addr(game_flags)
    STZ a:addr(level_manager_object.current_screen)
    REP #0x20
    LDA #addr(sub_C46359)
    STA a:addr(level_manager_object+object.handler)
    SEP #0x20
...
i16
    ...
    STA a:addr(bg1_v_scroll+1)
    LDA #0x20
    STA a:addr(level_manager_object.anonymous_6+1)
    LDY #0
    LDA #0
    STA z:0x40
    LDA #0
...
i16
    ...
    REP #0x20
    LDX #addr(player_1)
    STZ z:add_to_score.SCORE
    STZ z:add_to_score.SCORE + 2
    JSL add_to_score_if_allowed
    JSL draw_number_of_lives
    REP #0x20
    LDX #addr(player_2)
...
sub_C46FD8:
    ...
    ADC #0x30
    STA z:0x11,X
    start_animation #addr(byte_C462B0)
    JSL sub_C625D3
    REP #0x20
    LDA z:0x11,X
    CLC
    ...
    ADC #0x30
    STA z:0x14,X
    start_animation #addr(byte_C462B5)
    JSL sub_C625D3
    REP #0x20
    PLA
    STA z:0x14,X
...
i16
    REP #0x20
    STZ a:addr(allocator_cyclic_buffer_read_pointer)
...
-
    ...
    LDA #0
    STA a:addr(gameover_related_object.prev)
    
    LDA #0
    STA a:addr(gameover_related_object + 3)
    
    LDA #addr(hud_related_object)
    STA a:addr(gameover_related_object.next)
    
    REP #0x20
    LDA #addr(gameover_related_handler)
    STA a:addr(gameover_related_object.handler)
    SEP #0x20
    
    LDA #bank(gameover_related_handler)
    STA a:addr(gameover_related_object.handler + 2)
    
    REP #0x20
    LDX #addr(hud_related_object)
    
    LDA #addr(gameover_related_object)
    ...
    LDA #bank(hud_related_handler)
    STA z:dynamic_object.handler + 2,X
...
-
    ...
    REP #0x20
    LDA #addr(init_player_handler)
    STA a:addr(player_3+object.handler)
    SEP #0x20
    LDA #bank(init_player_handler)
    STA a:addr(player_3+object.handler+2)
    REP #0x20
    LDA #addr(init_player_handler)
    STA a:addr(player_4+object.handler)
    SEP #0x20
    LDA #bank(init_player_handler)
    STA a:addr(player_4+object.handler+2)
    LDA #0
    STA a:addr(player_1.current_bomb_count)
    LDA #0
    STA a:addr(player_2.current_bomb_count)
    LDA #0
    STA a:addr(player_3.current_bomb_count)
    LDA #0
    STA a:addr(player_4.current_bomb_count)
    LDA #0
    STA a:addr(word_7E0E48)
    LDA #0
    STA a:addr(word_7E0E88)
    LDA #0
    STA a:addr(word_7E0EC8)
    LDA #0
    STA a:addr(word_7E0F08)
    LDA #0
...
sub_C47770:
    ...
    LDA #0
    STA a:addr(unk_dboot_32),X
    STZ a:addr(unk_dboot_34),X
    RTL
...
i16
    SEP #0x20
    STZ a:addr(level_manager_object.enemy_count)
    STZ a:addr(player_1.is_ai)
    STZ a:addr(player_2.is_ai)
    ...
    LDA #2
    STA a:addr(player_2.real_palette)
    LDA #0xA
    STA a:addr(player_3.real_palette)
    LDA #8
    STA a:addr(player_4.real_palette)
    LDA a:addr(current_mode)
    CMP #3
    BEQ .loc_C47918
    JML .locret_C47A28
...
.loc_C47918:
    ...
    LDA a:addr(level_manager_object.unknown_flags)
    CLC
    ADC a:addr(level_manager_object.unknown_flags+1)
    STA a:addr(level_manager_object.enemy_count)
    LDA a:addr(level_manager_object.unknown_flags)
    STA a:addr(level_manager_object.number_of_human_players)
    LDA a:addr(level_manager_object.unknown_flags+1)
    STA a:addr(level_manager_object.number_of_ai_players)
...
.loc_C47976:
    ...
    LDA z:5,X
    SEC
    SBC a:addr(level_manager_object.unknown_flags)
    SEC
    SBC #3
    EOR #0xFF
    INC A
...
.loc_C47BDE:
    ...
    BEQ .loc_C47C32
    REP #0x20
    LDA a:addr(bg1_tilemap+0x86)
    STA a:addr(bg1_tilemap+0x24)
    LDA a:addr(bg1_tilemap+0x44)
