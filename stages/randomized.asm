...
stage_1_3:
    ...
    .WORD 2         ; Screen mode. Always 2 for story mode stages
    .WORD $50       ; saved_to_d3a, unknown
    .FARADDR warp_zone_graphic ; Tileset graphic
    .FARADDR bomb_and_explosions_graphic ; Bomb overlay graphic
    .FARADDR empty_tilemap ; Foreground Tileset (Despite the default being a tilemap!)
    .FARADDR warp_zone_level_structure ; Level structure
    .FARADDR empty_tilemap ; Foreground Tilemap
    ...
    .WORD 33         ; soft_blocks
                     ; Off by one in    story mode, for    the level exit
    .FARADDR load_palettes; Init functions and their parameters
    .FARADDR warp_zone_level_palettes
    .WORD $10 ; Number of palettes
    .BYTE 0 ; Unused?
    .FARADDR load_global_sprites
    .FARADDR standard_level_graphics
...
stage_3_8:
    ...
    .WORD 2         ; Screen mode. Always 2 for story mode stages
    .WORD $50       ; saved_to_d3a, unknown
    .FARADDR normal_zone_graphic ; Tileset graphic
    .FARADDR bomb_and_explosions_graphic ; Bomb overlay graphic
    .FARADDR empty_tilemap ; Foreground Tileset (Despite the default being a tilemap!)
    .FARADDR normal_zone_level_structure ; Level structure
    .FARADDR empty_tilemap ; Foreground Tilemap
    ...
    .WORD 33         ; soft_blocks
                     ; Off by one in    story mode, for    the level exit
    .FARADDR load_palettes; Init functions and their parameters
    .FARADDR normal_zone_level_palettes
    .WORD $10 ; Number of palettes
    .BYTE 0 ; Unused?
    .FARADDR load_global_sprites
    .FARADDR standard_level_graphics
...
stage_4_1:
    ...
    .WORD 2         ; Screen mode. Always 2 for story mode stages
    .WORD $50       ; saved_to_d3a, unknown
    .FARADDR tunnel_zone_graphic ; Tileset graphic
    .FARADDR bomb_and_explosions_graphic ; Bomb overlay graphic
    .FARADDR empty_tilemap ; Foreground Tileset (Despite the default being a tilemap!)
    .FARADDR tunnel_zone_level_structure ; Level structure
    .FARADDR empty_tilemap ; Foreground Tilemap
    ...
    .WORD 44         ; soft_blocks
                     ; Off by one in    story mode, for    the level exit
    .FARADDR load_palettes; Init functions and their parameters
    .FARADDR tunnel_zone_level_palettes
    .WORD $10 ; Number of palettes
    .BYTE 0 ; Unused?
    .FARADDR load_global_sprites
    .FARADDR standard_level_graphics
