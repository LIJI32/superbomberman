...
shield_palette_sequence:
    db PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, 0, 0, 0, 0
    db PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, 0, 0, 0, 0
    db PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, 0, 0, 0, 0
    db PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, 0, 0, 0, 0
    db PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, 0, 0, 0, 0
    ...
    db PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, 0, 0, PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, 0, 0
    db PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, 0, 0, PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, 0, 0
    db PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, 0, 0, PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, 0, 0
    db PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, 0, 0, PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, 0, 0
    db PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, 0, 0, PALETTE_STATIC_WHITE, PALETTE_STATIC_WHITE, 0, 0
    ...
    db PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0
    db PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0
    db PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0
    db PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0
    db PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0
    ...
    db PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0, PALETTE_STATIC_WHITE, 0
    .end
INVINCIBILITY_FRAMES = shield_palette_sequence.end - shield_palette_sequence
...
bonus_tiles:
    ...
    db 0x8E    ; 0x30
    db 0x15    ; 0x31
invisibility_flashing_sequence:
    db 0, 1, 1, 1, 1, 0, 0, 0
    db 0, 1, 1, 1, 1, 0, 0, 0
    db 0, 1, 1, 1, 0, 0, 0, 1
    db 1, 1, 0, 0, 0, 1, 1, 0
    db 0, 1, 1, 0, 0, 1, 0, 1
    .end
INVISIBILITY_FLASHING_LEGNTH = .end - invisibility_flashing_sequence
...
word_C32F81:
    dw 0x3D
screen_music_table:
macro world_music world
    rept 7
    dw MUSIC_WORLD_$world
    endr
    dw MUSIC_BOSS_$world
endmacro
    world_music 1
    world_music 2
    world_music 3
    ...
    world_music 6
    ; Special screens
    dw MUSIC_CREDITS, MUSIC_TITLE, MUSIC_BATTLE_MENU, MUSIC_CREDITS
    ; Demo screens
    dw MUSIC_BATTLE_MODE, MUSIC_BATTLE_MODE, MUSIC_BATTLE_MODE
    ; More special screens
    dw MUSIC_CONTINUE, MUSIC_CONTINUE, MUSIC_MAP, MUSIC_DRAW, MUSIC_VICTORY, MUSIC_BATTLE_MENU
    ; Battle stages
rept 12
