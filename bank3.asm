...
peace_town_palettes:.BYTE STORY_HUD_PALETTE, PEACE_TOWN_PALETTE_1, PEACE_TOWN_PALETTE_2; a_palettes
...
village_palettes:.BYTE STORY_HUD_PALETTE, VILLAGE_PALETTE_1, VILLAGE_PALETTE_2; a_palettes
		...
		.BYTE SHIRO_PALETTE, KURO_PALETTE, BOMB_PALETTE, RED_BOMB_PALETTE; b_palettes
		.BYTE FREE, FREE, FREE,	WHITE_PALETTE; b_palettes
castle_palettes:.BYTE STORY_HUD_PALETTE, CASTLE_PALETTE_1, CASTLE_PALETTE_2; a_palettes
		.BYTE CASTLE_PALETTE_3,	BONUS_PALETTE_1, BONUS_PALETTE_2; a_palettes
		.BYTE CASTLE_BOMB_PALETTE, CASTLE_FIRE_PALETTE;	a_palettes
		.BYTE SHIRO_PALETTE, KURO_PALETTE, BOMB_PALETTE, RED_BOMB_PALETTE; b_palettes
		.BYTE FREE, FREE, FREE,	WHITE_PALETTE; b_palettes
bigaron_boss_palettes:.BYTE STORY_HUD_PALETTE, BACKGROUND_BLACK_PALETTE, BACKGROUND_BLACK_PALETTE; a_palettes
...
park_palettes:	.BYTE STORY_HUD_PALETTE, PARK_PALETTE_1, PARK_PALETTE_2, PARK_PALETTE_3; a_palettes
		.BYTE BONUS_PALETTE_1, BONUS_PALETTE_2,	PARK_BOMB_PALETTE; a_palettes
		.BYTE PARK_FIRE_PALETTE	; a_palettes
		.BYTE SHIRO_PALETTE, KURO_PALETTE, BOMB_PALETTE, RED_BOMB_PALETTE; b_palettes
		.BYTE FREE, FREE, FREE,	WHITE_PALETTE; b_palettes
circus_palettes:.BYTE STORY_HUD_PALETTE, CIRCUS_PALETTE_1, CIRCUS_PALETTE_2; a_palettes
		.BYTE CIRCUS_PALETTE_3,	BONUS_PALETTE_1, BONUS_PALETTE_2; a_palettes
		.BYTE CIRCUS_BOMB_PALETTE, CIRCUS_FIRE_PALETTE;	a_palettes
		.BYTE SHIRO_PALETTE, KURO_PALETTE, BOMB_PALETTE, RED_BOMB_PALETTE; b_palettes
		.BYTE FREE, FREE, FREE,	WHITE_PALETTE; b_palettes
clown_mask_boss_palettes:.BYTE STORY_HUD_PALETTE, CLOWN_MASK_BOSS_PALETTE_1, CLOWN_MASK_BOSS_PALETTE_2; a_palettes
		.BYTE CLOWN_MASK_BOSS_PALETTE_3,	BONUS_PALETTE_1, BONUS_PALETTE_2; a_palettes
		.BYTE CLOWN_MASK_BOSS_BOMB_PALETTE, CLOWN_MASK_BOSS_FIRE_PALETTE;	a_palettes
		.BYTE SHIRO_PALETTE, KURO_PALETTE, BOMB_PALETTE, RED_BOMB_PALETTE; b_palettes
		.BYTE CLOWN_MASK_PALETTE_0, CLOWN_MASK_PALETTE_1, CLOWN_MASK_PALETTE_2;	b_palettes
		.BYTE WHITE_PALETTE	; b_palettes
garden_palettes:.BYTE STORY_HUD_PALETTE, GARDEN_PALETTE_1, GARDEN_PALETTE_2; a_palettes
		.BYTE GARDEN_PALETTE_3,	BONUS_PALETTE_1, BONUS_PALETTE_2; a_palettes
		.BYTE GARDEN_BOMB_PALETTE, GARDEN_FIRE_PALETTE;	a_palettes
		.BYTE SHIRO_PALETTE, KURO_PALETTE, BOMB_PALETTE, RED_BOMB_PALETTE; b_palettes
		.BYTE FREE, FREE, FREE,	WHITE_PALETTE; b_palettes
factory_palettes:.BYTE STORY_HUD_PALETTE, FACTORY_PALETTE_1, FACTORY_PALETTE_2; a_palettes
		...
		.BYTE SHIRO_PALETTE, KURO_PALETTE, BOMB_PALETTE, RED_BOMB_PALETTE; b_palettes
		.BYTE FREE, FREE, FREE,	WHITE_PALETTE; b_palettes
crane_hand_boss_palettes:.BYTE STORY_HUD_PALETTE, BACKGROUND_BLACK_PALETTE, BACKGROUND_BLACK_PALETTE;	a_palettes
		.BYTE BACKGROUND_BLACK_PALETTE,	BACKGROUND_BLACK_PALETTE; a_palettes
...
dome_palettes:	.BYTE STORY_HUD_PALETTE, DOME_PALETTE_1, DOME_PALETTE_2, DOME_PALETTE_3; a_palettes
		.BYTE BONUS_PALETTE_1, BONUS_PALETTE_2,	DOME_BOMB_PALETTE; a_palettes
		.BYTE DOME_FIRE_PALETTE	; a_palettes
		.BYTE SHIRO_PALETTE, KURO_PALETTE, BOMB_PALETTE, RED_BOMB_PALETTE; b_palettes
		.BYTE FREE, FREE, FREE,	WHITE_PALETTE; b_palettes
mecha_onita_boss_palettes:.BYTE	STORY_HUD_PALETTE, BACKGROUND_BLACK_PALETTE, BACKGROUND_BLACK_PALETTE; a_palettes
		.BYTE BACKGROUND_BLACK_PALETTE,	BACKGROUND_BLACK_PALETTE; a_palettes
		.BYTE BACKGROUND_BLACK_PALETTE,	BACKGROUND_BLACK_PALETTE; a_palettes
...
spiderer_boss_graphics:
		...
		.FARADDR score_banner_and_bomb_graphic
		.FARADDR explosion_graphic
speed_zone_palettes:.BYTE STORY_HUD_PALETTE, SPEED_ZONE_PALETTE_1, SPEED_ZONE_PALETTE_2; a_palettes
		...
		.BYTE SHIRO_PALETTE, KURO_PALETTE, BOMB_PALETTE, RED_BOMB_PALETTE; b_palettes
		.BYTE FREE, FREE, FREE,	WHITE_PALETTE; b_palettes
diamond_tower_palettes:.BYTE STORY_HUD_PALETTE, DIAMOND_TOWER_PALETTE_1, DIAMOND_TOWER_PALETTE_2; a_palettes
		...
		.BYTE SHIRO_PALETTE, KURO_PALETTE, BOMB_PALETTE, RED_BOMB_PALETTE; b_palettes
		.BYTE FREE, FREE, FREE,	WHITE_PALETTE; b_palettes
spiderer_boss_palettes:.BYTE STORY_HUD_PALETTE, BACKGROUND_BLACK_PALETTE, BACKGROUND_BLACK_PALETTE; a_palettes
		.BYTE BACKGROUND_BLACK_PALETTE,	BACKGROUND_BLACK_PALETTE; a_palettes
		.BYTE BACKGROUND_BLACK_PALETTE,	BACKGROUND_BLACK_PALETTE; a_palettes
		.BYTE BACKGROUND_BLACK_PALETTE;	a_palettes
		.BYTE BLACK_PALETTE, BLACK_PALETTE, BOMB_PALETTE, RED_BOMB_PALETTE; b_palettes
