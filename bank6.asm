...
kuwagen:
    ...
    LDA #0
    STA z:0x30, X
    start_animation #addr(byte_C63EB8)
    REP #0x20
    LDA #addr(off_C67D03)
    STA z:0x16, X
    SEP #0x20
...
senshiyan:
    ...
    LDA #0
    STA z:0x34, X
    start_animation #addr(byte_C64044)
    SEP #0x20
    LDA #3
    STA z:0x21, X
    LDA #0xFF
...
sub_C65C3B:
    REP #0x20
    start_animation #addr(byte_C6409D)
...
metal_propene:
    ...
    STA z:0x18, X
    REP #0x20
    start_animation #addr(byte_C641BE)
    SEP #0x20
    LDA #0x40
    STA z:0x21, X
    LDA #0xFF
...
propene:
    ...
    REP #0x20
    start_animation #addr(propene_animation)
    SEP #0x20
    LDA #3
    STA z:enemy.hits_left_for_direction_switch, X
    LDA #0xFF
...
starnuts:
    ...
    STA z:0x18, X
    REP #0x20
    start_animation #addr(byte_C65739)
    SEP #0x20
    LDA #3
    STA z:0x21, X
    LDA #0xFF
...
banen:
    ...
    STA z:0x18, X
    REP #0x20
    start_animation #addr(byte_C643C8)
    SEP #0x20
    LDA #0x30
    STA z:0xE, X
    LDA #3
...
cuppen:
    ...
    STA z:0x18, X
    REP #0x20
    start_animation #addr(byte_C6448A)
    SEP #0x20
    LDA #0x40
    STA z:0x21, X
    LDA #0xFF
...
keibin:
    ...
    STA z:0x18, X
    REP #0x20
    start_animation #addr(byte_C654D6)
    SEP #0x20
    LDA #0x40
    STA z:0x21, X
    LDA #0xFF
...
anzenda:
    ...
    STA z:0x18, X
    REP #0x20
    start_animation #addr(byte_C6458D)
    SEP #0x20
    LDA #3
    STA z:0x21, X
    LDA #0xFF
...
yoroisu:
    REP #0x20
    start_animation #addr(byte_C647D0)
    REP #0x20
    LDA #addr(off_C67D33)
    STA z:0x16, X
    SEP #0x20
...
missle:
    ...
    LDA #0
    STA z:0x1A, X
    start_animation #addr(byte_C648A6)
    SEP #0x20
    LDA #0x10
    STA z:0x30, X
    LDA #0
...
kouraru:
    ...
    STA z:0x18, X
    REP #0x20
    start_animation #addr(byte_C64910)
    SEP #0x20
    LDA #3
    STA z:0x21, X
    LDA #0xFF
...
pakupa:
    ...
    STA z:0x18, X
    REP #0x20
    start_animation #addr(byte_C64A13)
    SEP #0x20
    LDA #0x30
    STA z:0xE, X
    LDA #3
...
douken:
    ...
    STA z:0x18, X
    REP #0x20
    start_animation #addr(byte_C64AFC)
    SEP #0x20
    LDA #0x30
    STA z:0xE, X
    LDA #3
...
dengurin:
    ...
    STA z:0x18, X
    REP #0x20
    start_animation #addr(byte_C64C51)
    SEP #0x20
    LDA #0x40
    STA z:0x21, X
    LDA #0x40
...
robocom:
    ...
    LDA #0xE0
    STA z:0x1C, X
    start_animation #addr(byte_C64E6F)
    SEP #0x20
    LDA #0x30
    STA z:0xE, X
    LDA #1
...
metal_u:
    ...
    start_animation #addr(byte_C65842)
    SEP #0x20
    LDA #0x30
    STA z:0xE, X
    LDA #1
...
kinkaru:
    ...
    LDA #0xA0
    STA z:0x1C, X
    start_animation #addr(byte_C657E1)
    SEP #0x20
    LDA #0x30
    STA z:0xE, X
    LDA #1
...
moguchan:
    ...
    LDA #0xE0
    STA z:0x1C, X
    start_animation #addr(byte_C65038)
    SEP #0x20
    LDA #0x30
    STA z:0xE, X
    LDA #1
...
.loc_C67747:
    ...
    STA z:0x30, X
    REP #0x20
    start_animation #addr(byte_C6505A)
...
.loc_C677CE:
    REP #0x20
    start_animation #addr(byte_C65087)
...
bakuda:
    ...
    STA z:0x18, X
    REP #0x20
    start_animation #addr(byte_C6528C)
    SEP #0x20
    LDA #3
    STA z:0x21, X
    LDA #0xFF
...
.loc_C67A28:
    STY z:0x26, X
    start_animation #addr(byte_C652E6)
...
.loc_C67A65:
    ...
    LDA z:0x26, X
    STA z:0x56
    start_animation #addr(byte_C6530F)
    SEP #0x20
    LDA z:5, X
    PHA
    LDA #2
...
kierun:
    ...
    STA z:0x18, X
    REP #0x20
    start_animation #addr(byte_C653CE)
    SEP #0x20
    LDA #0x40
    STA z:0x21, X
    LDA #0xFF
...
sub_C67C34:
    REP #0x20
    start_animation #addr(byte_C653D7)
...
.loc_C67C6F:
    ...
    BCC .locret_C67C93
    REP #0x20
    start_animation #addr(byte_C65408)
...
.loc_C67CB1:
    ...
    REP #0x20
    start_animation #addr(byte_C65449)
